...
export default function Nav() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-paper/90 dark:bg-paper/90 backdrop-blur border-b border-charcoal/10 dark:border-charcoal/20">
      ...
      {/* Mobile dropdown */}
      {open && (
        <nav className="sm:hidden flex flex-col gap-1 px-6 pb-6 text-sm text-charcoal/80 dark:text-charcoal/90 bg-paper border-t border-charcoal/10 dark:border-charcoal/20">
          <Link
            href="/companies"
